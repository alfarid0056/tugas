...
$link = mysqli_connect('localhost', 'id8008084_admin', 'magangceria', 'id8008084_akademik');
...
if ($method == 'POST') {
        ...
        $nimmhsw=$json["nim"];
        $namamhsw=$json["nama"];
        $alamatmhsw=$json["alamat"];
		$querycek = "SELECT nim,nama,alamat FROM mahasiswa WHERE nim ='$nimmhsw'";
